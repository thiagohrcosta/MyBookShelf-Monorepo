...
RSpec.describe "Api::V1::Publishers", type: :request do
  ...
  describe "POST /api/v1/publishers" do
    it "creates a new publisher" do
      post '/api/v1/publishers', params: { publisher: { name: 'Test Publisher' } }
    ...
    it "returns error when name is missing" do
      post '/api/v1/publishers', params: { publisher: { name: '' } }
  ...
  describe "PATCH /api/v1/publishers/:id" do
    it "updates a publisher" do
      ...
      patch "/api/v1/publishers/#{publisher.id}", params: { publisher: { name: 'Updated Name' } }
    ...
    it "returns 404 when publisher not found" do
      patch '/api/v1/publishers/99999', params: { publisher: { name: 'Updated' } }
  ...
  describe "DELETE /api/v1/publishers/:id" do
    ...
    it "returns 404 when publisher not found" do
      delete '/api/v1/publishers/99999'
